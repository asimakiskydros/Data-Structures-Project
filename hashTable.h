...
{
  private:
    int arrSize; //the size of the hash table
    int usedBuckets; //the number of the non-empty buckets in the hash table
    ...
    unsigned int hash2(unsigned int);//hash2 function

    int length;//length of the given word

    unsigned int indx; //index of the value of the pair class
  public:
